...
def postBulkMessage():
    postbulkSMS= {
        ...
        "messages": [{"messageID":"4c2c60d1","text":"Hello World", "phonenumber":"233278009427"},
                     {"messageID":"d87801fe","text":"Hello 2 World","phonenumber":"233200313710"}],
        "senderID": "Cowry",
        "messageType": "SMS",
        "callback": 1,
        "dlr-url": " ",
...
def postMessage():
    postMess= {
        "api_key":  "61b87502373649d09c01cffe9e1dcbd3",
        "service_provider_id": "3006bee1f78047e8811f536122e2877a",
        "source": "api","routeID":"8f1df72288915292efcf456df43e5b20",
        "text":"Invoice no.XYZ-GH-090 has been uploaded by Beige",
        "senderID": "ADB",
        "messageID": "4c2c60d1",
        "messageType":"SMS",
